      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-3">
        <Card className="bg-[#090d16]/30 border-slate-900">
          <CardContent className="pt-6">
            ...
            <p className="text-[10px] text-slate-500 mt-1">
              Average time from PR opening to merge
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#090d16]/30 border-slate-900">
          <CardContent className="pt-6">
            ...
            <p className="text-[10px] text-slate-500 mt-1">
              Open pull requests across tracked repos
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#090d16]/30 border-slate-900">
          <CardContent className="pt-6">
            ...
            <p className="text-[10px] text-slate-500 mt-1">
              Repositories actively synchronized
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-2 bg-gradient-to-br from-[#090d16]/60 to-[#030712] border-indigo-950/40 relative overflow-hidden">
          ...
          <CardHeader className="flex flex-row items-center gap-2">
            ...
            <div>
              ...
              <CardDescription className="text-xs text-slate-400">
                Deterministic code and process evaluations.
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex gap-3.5 p-3.5 rounded-lg bg-indigo-950/20 border border-indigo-900/40 text-xs">
              ...
              <div>
                ...
                <span className="text-slate-400 leading-relaxed">
                  ...
                  dropped 12% last week due to stale reviews on module security
                  filters.
                </span>
              </div>
            </div>
            <div className="flex gap-3.5 p-3.5 rounded-lg bg-indigo-950/20 border border-indigo-900/40 text-xs">
              ...
              <div>
                <span className="font-semibold text-indigo-300 block mb-0.5">
                  VCS Review Bottleneck Risk
                </span>
                <span className="text-slate-400 leading-relaxed">
                  PR #14 has 12 comments with 4 reviews pending merge. Action
                  recommended to resolve review deadlock.
                </span>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="bg-[#090d16]/30 border-slate-900">
          <CardHeader>
            ...
            <CardDescription className="text-xs text-slate-400">
              Ingested events across repositories.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex flex-col gap-1 text-xs">
              ...
              <span className="text-slate-200">
                <strong className="text-white">coder_dev</strong> merged PR #14
                on <code className="text-slate-400">devflow-backend</code>
              </span>
            </div>
            <div className="flex flex-col gap-1 text-xs">
              <span className="text-slate-500">4h ago</span>
              <span className="text-slate-200">
                <strong className="text-white">reviewer_team</strong> requested
                changes on PR #12
              </span>
            </div>
            <div className="flex flex-col gap-1 text-xs">
              ...
              <span className="text-slate-200">
                <strong className="text-white">coder_dev</strong> pushed 3
                commits to <code className="text-slate-400">main</code>
              </span>
            </div>
          </CardContent>
        </Card>
