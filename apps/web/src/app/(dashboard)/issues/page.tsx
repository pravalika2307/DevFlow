...
const issues: Issue[] = [
  {
    id: "i1",
    number: "142",
    title: "Configure Alembic environment to discover model packages",
  ...
  },
  {
    id: "i2",
    number: "140",
    title: "Docker Container connection timed out under local network load",
    repo: "devflow-worker",
    priority: "P0",
    state: "open",
  },
  {
    id: "i3",
    number: "135",
    title: "Enable ESLint configuration settings inside packages config",
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">
          Track task assignments, prioritizations, and workflow status.
        </p>
      </div>
